...
// стога сена - таблица
    ...
    private Double needle1=0.0;
    private Double needle2=0.0;
...
// Иначе - в обычный белый
        ...
        if ( needle1 < needle2 && needle1<=Double.parseDouble(formattedDouble) && needle2>=Double.parseDouble(formattedDouble) ) {
// Номер столбца = 1 (т.е. второй столбец) + иголка не null
// (значит что-то ищем) +
// значение иголки совпадает со значением ячейки таблицы -
// окрасить задний фон панели в красный цвет
